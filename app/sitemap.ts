...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${baseUrl}/areas/zip-89128`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/areas/zip-89135`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/areas/zip-89144`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/areas/zip-89117`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/homes/under-300k`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/homes/400k-500k`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/homes/500k-plus`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/buyers/moving-to-las-vegas`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/services/buyer-representation`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    ...
    {
      url: `${baseUrl}/buyers/financing-new-construction`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.9,
    },
    ...
    {
      url: `${baseUrl}/services/building-standards-inspection`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/buyers/new-construction-vs-resale`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.9,
    },
