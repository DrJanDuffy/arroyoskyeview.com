...
export default function ReviewSchema() {
  ...
  const reviewSchema = {
    ...
    url: businessId,
    description: 'Expert buyer representation for new construction homes in Las Vegas, Nevada. Dr. Jan Duffy provides construction monitoring, building standards inspection, and insider knowledge of new construction homes.',
    address: {
      '@type': 'PostalAddress',
