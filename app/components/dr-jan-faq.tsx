...
const faqs = [
  ...
  {
    question: 'What makes Dr. Jan different from going directly to the builder\'s agent?',
    answer: 'The builder\'s entire team—from model home agents to carpenters—works exclusively for Century Communities, not for you. Dr. Jan monitors construction quality and advocates solely for your interests. Homes for Sale Vegas',
  },
  {
    question: 'Which Century Communities are best for [families/first-time buyers/investors]?',
    answer: 'Let\'s talk—Dr. Jan knows the ins and outs of every community. Call/text 702-222-1964',
  },
]
