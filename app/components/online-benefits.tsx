const benefits = [
  ...
  {
    title: 'Speed',
    description: 'Complete your purchase in minutes, not hours. Fast-track your homebuying journey.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Security',
    description: 'Bank-level encryption and secure payment processing protect your information.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Transparency',
    description: 'See all pricing, options, and fees upfront. No surprises or hidden costs.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Flexibility',
    description: 'Change your mind? Modify your selection or cancel within the specified timeframe.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
