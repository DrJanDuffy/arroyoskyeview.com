        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <a
              ...
              className="inline-flex items-center justify-center space-x-2 bg-blue-700 text-white px-8 py-4 rounded-md text-lg font-semibold hover:bg-blue-600 transition shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
